...
function handleSearch1(response) {
  ...
  resultsOfSearch1El.innerHTML = "<h2>Weather:</h2>";
  for (var i = 0; i < 1; i++) {
...
function handleSearch2(response) {
  ...
  resultsOfSearch2El.innerHTML = "<h2>Top 5 Things to Do:</h2>";
  for (var i = 0; i < 5; i++) {
    var item = response.items[i];
    var index = i + 1;
...
function handleSearch3(response) {
  ...
  resultsOfSearch3El.innerHTML = "<h2>Top 5 Places to Eat:</h2>";
  for (var i = 0; i < 5; i++) {
    var item = response.items[i];
    var index = i + 1;
...
function handleSearch4(response) {
  console.log("handleSearch4");
  var resultsOfSearch4El = document.getElementById("resultsOfSearch4");
  resultsOfSearch4El.innerHTML = "<h2>Top 5 Places to Sleep:</h2>";
  for (var i = 0; i < 5; i++) {
    var item = response.items[i];
    var index = i + 1;
    resultsOfSearch4El.innerHTML += "<p><a href='" + item.image.contextLink + "' target='_blank'>" + index + ". " + item.htmlTitle + "</a></p><p><img src='" + item.link + "'><br/><br/></p> ";
  }
}
...
function handleFormSubmit(event) {
  ...
  var googleSearch1 = "https://www.googleapis.com/customsearch/v1?key=AIzaSyDFM9Zvcj3uG-iHT16CNPqEEs7z3LhVUYA&cx=84bf6c59ec9dc5496&searchType=image&q=weather " + city + " " + state + "&callback=handleSearch1";
  var googleSearch2 = "https://www.googleapis.com/customsearch/v1?key=AIzaSyDFM9Zvcj3uG-iHT16CNPqEEs7z3LhVUYA&cx=84bf6c59ec9dc5496&searchType=image&q=things to do " + city + " " + state + "&callback=handleSearch2";
  var googleSearch3 = "https://www.googleapis.com/customsearch/v1?key=AIzaSyDFM9Zvcj3uG-iHT16CNPqEEs7z3LhVUYA&cx=84bf6c59ec9dc5496&searchType=image&q=restaurants " + city + " " + state + "&callback=handleSearch3";
  var googleSearch4 = "https://www.googleapis.com/customsearch/v1?key=AIzaSyDFM9Zvcj3uG-iHT16CNPqEEs7z3LhVUYA&cx=84bf6c59ec9dc5496&searchType=image&q=hotels " + city + " " + state + "&callback=handleSearch4";
  ...
  var googleScriptEl4 = document.createElement("script");
  ...
  googleScriptEl4.src = googleSearch4;
  googleScriptEl4.id = "googleScript4";
  ...
  document.body.appendChild(googleScriptEl4);
